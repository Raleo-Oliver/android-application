    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.dial_item:
                ...
                if (Build.VERSION.SDK_INT >= M) {
                    if (getApplicationContext().checkSelfPermission(Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                        ActivityCompat.requestPermissions(VaccineActivity.this,new String[]{Manifest.permission.CALL_PHONE},100);;
                    }
                }
            ...
            case R.id.email_item:
                ...
                return true;
            case R.id.code_item:
                Intent intentCode = new Intent(VaccineActivity.this, DisplayCodeActivity.class);
                startActivity(intentCode);
                return true;
            case R.id.about_item:
                Intent intentabout= new Intent(VaccineActivity.this, AboutVaccineActivity.class);
